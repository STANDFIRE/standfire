...
/**	FiLayerVirtualDialog : Layer virtual shape choice
*
*	@author I. Lecomte - march 2008
*/
public class FmLayerVirtualDialog extends AmapDialog implements ActionListener {
	...
	/**	Constructor.
	*/
	public FmLayerVirtualDialog (FmModel _model, FmDBPlant _plant, FmDBShape _sample, FmDBShape _sampleEdge) {
	...
	private boolean controlValues ()   {
		...
		if ((sample == null)  && (sampleEdge == null)) {
			...
			if (!Check.isInt (zVoxelField.getText ())) {
						JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.zVoxelSizeIsNotInt"),
						Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
						return false;
			}
			zVoxelSize = Integer.parseInt (zVoxelField.getText ());
			if (zVoxelSize == 0) {
					JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.zVoxelSizeIsNotFilled"),
					Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
					return false;
			}
			...
			if (Check.isEmpty (xVoxelField.getText ()) ) xVoxelField.setText("0");
			if (!Check.isInt (xVoxelField.getText ())) {
					JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.xVoxelSizeIsNotInt"),
					Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
					return false;
			}
			xVoxelSize = Integer.parseInt (xVoxelField.getText ());
			if (xVoxelSize == 0) {
					JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.xVoxelSizeIsNotFilled"),
					Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
					return false;
			}
			...
			if (!Check.isInt (yVoxelField.getText ())) {
					JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.yVoxelSizeIsNotInt"),
					Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
					return false;
			}
			yVoxelSize = Integer.parseInt (yVoxelField.getText ());
			if (yVoxelSize == 0) {
					JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.yVoxelSizeIsNotFilled"),
					Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
					return false;
			}
			...
			if (isSampleCoreCreation) {
				...
				if (!Check.isInt (zCoreSampleField.getText ())) {
						JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.zCoreSampleSizeIsNotInt"),
						Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
						return false;
				}
				zCoreSampleSize = Integer.parseInt (zCoreSampleField.getText ());
				if (zCoreSampleSize == 0) {
						JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.zCoreSampleSizeIsNotFilled"),
						Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
						return false;
				}
				if (zCoreSampleSize%zVoxelSize != 0) {
						JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.zCoreSampleSizeIsNotValid"),
						Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
						return false;
				}
			}
			...
			if (isSampleEdgeCreation) {
				...
				if (!Check.isInt (zEdgeSampleField.getText ())) {
						JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.zEdgeSampleSizeIsNotInt"),
						Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
						return false;
				}
				zEdgeSampleSize = Integer.parseInt (zEdgeSampleField.getText ());
				if (zEdgeSampleSize == 0) {
						JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.zEdgeSampleSizeIsNotFilled"),
						Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
						return false;
				}
				if (zEdgeSampleSize%zVoxelSize != 0) {
						JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.zEdgeSampleSizeIsNotValid"),
						Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
						return false;
				}
		...
		if ((!isCore) && (!isEdge)) {
			JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.selectOneShape"),
			Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
			return false;
		}
		...
		if (isCore) {
			...
			if (!Check.isInt (zMaxCoreField.getText ())) {
						JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.zMaxSizeIsNotInt"),
						Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
						return false;
			}
			zMaxCoreSize = Integer.parseInt (zMaxCoreField.getText ());
			if (zMaxCoreSize == 0) {
					JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.zMaxSizeIsNotFilled"),
					Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
					return false;
			}
			if (zMaxCoreSize%zVoxelSize != 0) {
					JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.zMaxSizeIsNotValid"),
					Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
					return false;
			}
			...
			if (!Check.isInt (xMaxCoreField.getText ())) {
					JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.xMaxSizeIsNotInt"),
					Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
					return false;
			}
			xMaxCoreSize = Integer.parseInt (xMaxCoreField.getText ());
			if (xMaxCoreSize == 0) {
					JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.xMaxSizeIsNotFilled"),
					Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
					return false;
			}
			if (xMaxCoreSize%xVoxelSize != 0) {
					JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.xMaxSizeIsNotValid"),
					Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
					return false;
			}
		...
		if (isEdge) {
			...
			if (!Check.isInt (zMaxEdgeField.getText ())) {
						JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.zMaxEdgeSizeIsNotInt"),
						Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
						return false;
			}
			zMaxEdgeSize = Integer.parseInt (zMaxEdgeField.getText ());
			if (zMaxEdgeSize == 0) {
					JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.zMaxEdgeSizeIsNotFilled"),
					Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
					return false;
			}
			if (zMaxEdgeSize%zVoxelSize != 0) {
					JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.zMaxEdgeSizeIsNotValid"),
					Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
								return false;
			}
			...
			if (Check.isEmpty (xMaxEdgeField.getText ()) ) xMaxEdgeField.setText("0");
				if (!Check.isInt (xMaxEdgeField.getText ())) {
						JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.xMaxEdgeSizeIsNotInt"),
						Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
						return false;
				}
				xMaxEdgeSize = Integer.parseInt (xMaxEdgeField.getText ());
				if (xMaxEdgeSize == 0) {
						JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.xMaxEdgeSizeIsNotFilled"),
						Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
						return false;
				}
				if (xMaxEdgeSize%xVoxelSize != 0) {
						JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.xMaxEdgeSizeIsNotValid"),
						Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
						return false;
			}
		...
		if (!Check.isInt (spreadMaxField.getText ())) {
				JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.widthMaxIsNotInt"),
				Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
				return false;
		}
		spreadMaxSize = Integer.parseInt (spreadMaxField.getText ());
		if (spreadMaxSize == 0) {
				JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.widthMaxIsNotFilled"),
				Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
				return false;
		}
		if ((spreadMaxSize < widthMinSize) ||  (spreadMaxSize < widthMaxSize)) {
				JOptionPane.showMessageDialog (this, Translator.swap ("FiLayerVirtualDialog.widthMaxIsNotValid"),
				Translator.swap ("Shared.warning"), JOptionPane.WARNING_MESSAGE );
				return false;
		}
		return true;
	...
	private void validateAction () {
		...
		if (controlValues() ) {
			...
			try {
				...
				//no sample, the cage method is used
				if ((sample == null)  && (sampleEdge == null)) {
					isCubeMethod = false;
					shape = new FmDBShape (shapeId, plant,
										...
										isCubeMethod,
										false,false);
					FmLayer2DCageEditor dialog = new FmLayer2DCageEditor (model, shape);
					...
					shape = new FmDBShape (shapeId, plant,
										...
										isCubeMethod,
										false,false);
					FmLayer2DEditor dialog = new FmLayer2DEditor (model, shape, sample, sampleEdge);
					shapeId = dialog.getShapeId();
				...
				Log.println (Log.ERROR, "FiLayerVirtualDialog", "error while UPDATE shape in data base", e);
			}
		}
	...
	*/
	private void createUI () {
		...
		Border sampleBorder = BorderFactory.createTitledBorder (sampleEtched, Translator.swap ("FiLayerVirtualDialog.samplesDef"));
		...
		v1.add (new JWidthLabel (Translator.swap ("FiLayerVirtualDialog.zVoxelSize")+" :", 150));
		v1.add (zVoxelField);
		v1.add (new JWidthLabel (Translator.swap ("FiLayerVirtualDialog.xVoxelSize")+" :", 10));
		v1.add (xVoxelField);
		v1.add (new JWidthLabel (Translator.swap ("FiLayerVirtualDialog.yVoxelSize")+" :", 10));
		v1.add (yVoxelField);
		...
		v4.add (new JWidthLabel (Translator.swap ("FiLayerVirtualDialog.coreSample")+" :", 200));
		...
		v5.add (new JWidthLabel (Translator.swap ("FiLayerVirtualDialog.edgeSample")+" :", 200));
		...
		Border shapeBorder = BorderFactory.createTitledBorder (shapeEtched, Translator.swap ("FiLayerVirtualDialog.shapeDimension"));
		...
		v6.add (layerCore);
		v6.add (new JWidthLabel (Translator.swap ("FiLayerVirtualDialog.zMaxSize")+" :", 124));
		v6.add (zMaxCoreField);
		v6.add (new JWidthLabel (Translator.swap ("FiLayerVirtualDialog.xMaxSize")+" :", 50));
		...
		v7.add (layerEdge);
		v7.add (new JWidthLabel (Translator.swap ("FiLayerVirtualDialog.zMaxEdgeSize")+" :", 124));
		v7.add (zMaxEdgeField);
		v7.add (new JWidthLabel (Translator.swap ("FiLayerVirtualDialog.xMaxEdgeSize")+" :", 50));
		...
		Border layerBorder = BorderFactory.createTitledBorder (layerEtched, Translator.swap ("FiLayerVirtualDialog.layerDimension"));
		...
		v8.add (new JWidthLabel (Translator.swap ("FiLayerVirtualDialog.widthMinSize")+" :", 150));
		v8.add (widthMinField);
		v9.add (new JWidthLabel (Translator.swap ("FiLayerVirtualDialog.widthMaxSize")+" :", 150));
		v9.add (widthMaxField);
		v10.add (new JWidthLabel (Translator.swap ("FiLayerVirtualDialog.spreadMaxSize")+" :", 150));
		...
		save = new JButton (Translator.swap ("FiLayerVirtualDialog.save"));
		...
		setTitle (Translator.swap ("FiLayerVirtualDialog.title"));
