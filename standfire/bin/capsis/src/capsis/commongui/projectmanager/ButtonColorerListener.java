...
/**	ButtonColorerListener must be implemented by objects listening
 *  to the ButtonColorer
 * 
 *	@author F. de Coligny - april 2010
 */
public interface ButtonColorerListener {
	
	/**	Called when the user moved a color from a StepButton to another
	 *	in the ProjectManager	
	 */
	public void colorMoved(StepButton previousButton, StepButton newButton);
	
	/**	Called when the user removed the color of a StepButton in the ProjectManager
	 */
