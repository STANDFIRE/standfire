...
public class UpdateEvent extends java.util.EventObject {
	...
	public UpdateSource getSource () {return (UpdateSource) source;}
	public void setParam (Object p) {param = p;}
	public Object getParam () {return param;}
	
	public String toString () {return "UpdateEvent: source="+source+" param="+param;}
}
