...
public class DETimeGWithCI extends AbstractDETimeWithCI {
	
	protected enum MessageID implements TextableEnum {
		Description("Basal area with confidence intervals", "Surface terri\u00E8re avec intervalles de confiances"),
		Name("CI - Basal Area", "IC - Surface terri\u00E8re"),
		;
	 ...
	 */
	public DETimeGWithCI(GenericExtensionStarter s) {
		super(s, Variable.G);
