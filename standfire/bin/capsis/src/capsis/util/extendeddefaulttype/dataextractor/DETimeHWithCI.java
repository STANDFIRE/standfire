...
public class DETimeHWithCI extends AbstractDETimeWithCI {
	
	protected enum MessageID implements TextableEnum {
		Description("Dominant height with confidence intervals", "Hauteur dominante avec intervalles de confiances"),
		Name("CI - H0", "IC - H0"),
		;
	 ...
	 */
	public DETimeHWithCI(GenericExtensionStarter s) {
		super(s, Variable.H);
