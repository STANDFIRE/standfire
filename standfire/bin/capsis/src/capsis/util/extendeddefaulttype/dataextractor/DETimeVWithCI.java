...
public class DETimeVWithCI extends AbstractDETimeWithCI {
	
	protected enum MessageID implements TextableEnum {
		Description("Volume with confidence intervals", "Volume avec intervalles de confiances"),
		Name("CI - Volume", "IC - Volume"),
		;
	 ...
	 */
	public DETimeVWithCI(GenericExtensionStarter s) {
		super(s, Variable.V);
