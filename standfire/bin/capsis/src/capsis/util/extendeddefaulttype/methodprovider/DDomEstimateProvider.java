...
/**
 * This interface ensures the stand can provide an estimate of its dominant diameter. This interface is 
 * required for confidence interval calculation.
 * @author Mathieu Fortin - June 2015
 */
public interface DDomEstimateProvider {

	/**	
	 * This method returns an Estimate of the dominant diameter.
