...
/**
 * The NEstimateProvider interface is required for those graphs with confidence intervals.
 * @author Mathieu Fortin - June 2015
 */
public interface NEstimateProvider {
	 ...
	 */
	public Estimate<?> getNPerHaEstimate(GScene stand, Collection trees);
