...
/**	An interface for 'basal area' to be applied 
...
public interface MuG {
	...
	/** Returns the basal area (m2) of the given ScenePart.
	 */
	public double getBasalArea (MultipartScene scene, ScenePart part);
