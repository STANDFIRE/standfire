...
/**	An interface for merchant volume to be applied 
 * 	on the parts of a multipart scene (ScenePart, MultipartScene).
 * 
 *	@author F. de Coligny - february 2011 
 */
public interface MuMerchantVolume {

	/** Returns the merchant volume (m3) of the given ScenePart.	
	 */
	public double getMerchantVolume (MultipartScene scene, ScenePart part);
