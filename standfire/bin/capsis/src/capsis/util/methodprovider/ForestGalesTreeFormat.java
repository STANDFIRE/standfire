 ...
 * between a given module and ForestGalesTree.
 * It must be implemented by the module's stand and tree object.
 *
 * @author C. Meredieu  - august 2003
 */
public interface ForestGalesTreeFormat {
	// Tartinate v. tr. CULIN.  To butter; to spread (with);
	// ARGOT. (South-west of France) to use british software

	// 1. Used to create .fgi tree file
	//
	public int getId () ;			 //m
	public double getHeight () ; 	//m
	public double getDbh () ;		 //cm

	// 2. Used to tartinate forestGalesTree values
