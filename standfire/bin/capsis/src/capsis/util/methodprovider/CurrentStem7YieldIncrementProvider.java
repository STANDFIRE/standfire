...
/**
 * Current Stem7 yield increment (calculated on Stem7 volume)
 ...
 */
public interface CurrentStem7YieldIncrementProvider extends MethodProvider {

	/**	Current Stem yield increment.
	 */
	public double getCurrentStem7YieldIncrement (TreeList prevStand, TreeList stand, double minDbh);
