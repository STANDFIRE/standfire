...
/**
 * Stand volume with Honer parameters (used in Ontario and Quebec, Canada)
 ...
 */
public interface VHonerProvider extends MethodProvider {

	/**	Stand trees from which we can calculate volume
	*	from Honer parameters for trees under maxDbh
	*/
	public double getVHoner (GScene stand, Collection trees, double maxDbh);
