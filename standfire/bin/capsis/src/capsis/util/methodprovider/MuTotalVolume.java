...
/**	An interface for total volume to be applied 
 * 	on the parts of a multipart scene (ScenePart, MultipartScene).
 * 
 *	@author F. de Coligny - february 2011 
 */
public interface MuTotalVolume {

	/** Returns the total volume (m3) of the given ScenePart.	
	 */
	public double getTotalVolume (MultipartScene scene, ScenePart part);
