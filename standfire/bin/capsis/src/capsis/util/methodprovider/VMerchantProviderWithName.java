...
/**	Merchantable stand (or given trees) volume, with name of the volume.
*	@author R. Schneider, F. de Coligny - may 2008
*/
public interface VMerchantProviderWithName extends VProvider {

	/**	Returns the merchant volume of the given trees. Note : some
