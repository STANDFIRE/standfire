 ...
 */
public interface TreeVHonerProvider extends MethodProvider {

	/**	Individual tree from which we can calculate volume
	*	from Honer parametersùs
	*/
	public double getTreeVHoner (VHonerTree tree);
