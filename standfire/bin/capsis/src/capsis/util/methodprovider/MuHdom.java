...
/**	An interface for 'dominant height' to be applied 
 * 	on the parts of a multipart scene (ScenePart, MultipartScene).
 * 
 *	@author F. de Coligny - january 2011 
 */
public interface MuHdom {

	/** Returns the dominant height (m) of the given ScenePart.	
	 */
	public double getHdom (MultipartScene scene, ScenePart part);
