...
/**	An interface for 'dominant diameter' to be applied 
 * 	on the parts of a multipart scene (ScenePart, MultipartScene).
 * 
 *	@author F. de Coligny - february 2011 
 */
public interface MuDdom {

	/** Returns the dominant diameter (cm) of the given ScenePart.	
	 */
	public double getDdom (MultipartScene scene, ScenePart part);
