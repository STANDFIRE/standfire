...
/**	An interface for stand mean quadratic diameter to be applied 
 * 	on the parts of a multipart scene (ScenePart, MultipartScene).
 * 
 *	@author F. de Coligny - january 2011 
 */

public interface MuDg {

	/** Returns the mean quadratic diameter (cm) of the given ScenePart.
	 */
	public double getDg (MultipartScene scene, ScenePart part);
