...
/**	FgOak "sawing" product.
*	For industrial sawing.
*	@author F. Mothe - N. Robert, sept 2008
*/
public class FgOakSawingLogCategory extends GeoLogLogCategory {

	private static final long serialVersionUID = 20101025L;

	//	Constructor
	public FgOakSawingLogCategory (int id) {
		super(id, Translator.swap("FgOakSawingProduct.name"), FgSpecies.OAK.getName(), -1, false, 3.0, 5.0, 25, 1, true);
	}
