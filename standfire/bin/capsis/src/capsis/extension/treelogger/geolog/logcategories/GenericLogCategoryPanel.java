...
/**	
 * GenericProductPanel : panel for editing the logging rules
 * of a FgOakLvlProduct
 * @author F. Mothe - february 2006
 */
public class GenericLogCategoryPanel extends GeoLogLogCategoryPanel {
	...
	private JFormattedNumericField maxJuveDiam_cm;

	/**	
	 * Default constructor.
	 */
	public GenericLogCategoryPanel (GeoLogLogCategory product) {
		super (product);
	}
	...
	protected void instantiateVariables() {
		...
		minHeartDiam_cm = NumberFormatFieldFactory.createNumberFormatField(10,
				...
				NumberFormatFieldFactory.Range.All,
				false);
		maxJuveDiam_cm = NumberFormatFieldFactory.createNumberFormatField(10,
				NumberFormatFieldFactory.Type.Double,
				NumberFormatFieldFactory.Range.All,
				false);
	}
	...
	public void refreshInterface() {
		...
		maxJuveDiam_cm.setText ("" + getTreeLogCategory().maxJuveDiam_cm);
	}
	...
	protected void createUI () {
		...
		col.add (DiaUtil.newTextComponent ("GenericProductPanel.maxKnotDiam_cm", WIDTH,
				maxKnotDiam_cm, NB_COL, getTreeLogCategory().maxKnotDiam_cm));
		col.add (DiaUtil.newTextComponent ("GenericProductPanel.minHeartDiam_cm", WIDTH,
				minHeartDiam_cm, NB_COL, getTreeLogCategory().minHeartDiam_cm));
		col.add (DiaUtil.newTextComponent ("GenericProductPanel.maxJuveDiam_cm", WIDTH,
				maxJuveDiam_cm, NB_COL, getTreeLogCategory().maxJuveDiam_cm));
	...
	@Override
	public GenericLogCategory getTreeLogCategory() {
		return (GenericLogCategory) this.logCategory;
	}
	...
	protected void updateValue(DocumentEvent e) {
		...
		} else if (e.getDocument().equals(maxJuveDiam_cm.getDocument())) {
			getTreeLogCategory().maxJuveDiam_cm = maxJuveDiam_cm.getValue().doubleValue();
		} else {
			super.updateValue(e);
		}
	}
	...
	public void listenTo() {
		...
		maxJuveDiam_cm.getDocument().addDocumentListener(this);
	}
	...
	public void doNotListenToAnymore() {
		...
		maxJuveDiam_cm.getDocument().removeDocumentListener(this);
	}
