...
import capsis.lib.quest.knotviewer.QuestKnotViewer;
...
public class MemoryMonitor extends AmapDialog implements ActionListener {
	...
	/**
	 * Test fc-19.3.2015 can we start this extension outside of Capsis ? (yes)
	 */
	public static void main(String[] args) {
		...
		MemoryMonitor mm = new MemoryMonitor(f);
