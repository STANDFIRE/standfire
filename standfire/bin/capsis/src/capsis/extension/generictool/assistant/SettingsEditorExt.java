...
/**
 * SettingsEditorExt opens the SettingsEditor.
 * 
 * @author F. de Coligny - october 2011
 */
public class SettingsEditorExt implements GenericTool {

	static {
		Translator.addBundle ("capsis.extension.generictool.assistant.SettingsEditor");
	}
	public static final String NAME = Translator.swap ("SettingsEditor");
	public static final String DESCRIPTION = Translator.swap ("SettingsEditor.description");
	 ...
	 * Default constructor.
	 */
	public SettingsEditorExt () {
	}

	@Override
	public void init (Window window) throws Exception {

		new SettingsEditor (window);
