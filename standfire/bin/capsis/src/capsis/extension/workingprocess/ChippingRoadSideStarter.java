...
/**	All parameters for ChippingRoadSide.
*
*	@author O. Pain - october 2007
*/
public class ChippingRoadSideStarter extends WorkingProcessStarter {

	public ChippingRoadSideStarter (String priceUnit,
			double price,
			String fuelUnit,
			double fuel,
