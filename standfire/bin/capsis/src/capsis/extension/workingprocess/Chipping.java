...
/**	Chipping in forest with mobile material = chipping + forwarding in one WP
*
*	@author O. Pain - october 2007
*/
public class Chipping extends PaleoWorkingProcess {

	static {
		Translator.addBundle("capsis.extension.workingprocess.Chipping");
	}
	...
	*/
	public Chipping (GenericExtensionStarter s) throws Exception {
		super (s);
	}
	...
	*/
	...
	public String getName () {
		return Translator.swap ("Chipping");
	}
	...
	/**	Extension interface */
	public String getDescription () {return Translator.swap ("Chipping.description");}

	public ChippingStarter getStarter () {return (ChippingStarter) starter;}
	...
	*/
	public void execute () throws Exception {
		...
		// create Product.CHIPS_ROADSIDE from TREE, LOG or BUNDLE
		if (starter.requestedOutputProductNames.contains (Product.CHIPS_ROADSIDE)) {
			...
			addProduct (output);
			Log.println (Log.INFO, "Chipping.execute ()", "Chipping WP made: "+output);
		}
	}
