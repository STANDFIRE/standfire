...
/**
 * AskAgainDialog is a dialog box to enter parameters for the related request.
 * 
 * @author F. de Coligny - november 2002
 */
public class AskAgainDialog extends AmapDialog implements ActionListener {

	private AskAgain request;
	...
	public AskAgainDialog (AskAgain request) {
		super ();
	...
	private void okAction () {
		...
		try {
			...
			MessageDialog.print (this, Translator.swap ("AskAgainDialog.wrongSyntax"), e);
			return;
		}
		
		if (ids == null || ids.length == 0) {
			MessageDialog.print (this, Translator.swap ("AskAgainDialog.wrongSyntax")+" ids="+ids);
			return;
		} else {
			try {
	...
	private void createUI () {
		...
		l1.add (new JWidthLabel (Translator.swap ("AskAgainDialog.messageId")+" :", 120));
		messageId = new JTextField (10);
		l1.add (messageId);
		l1.addStrut0 ();
		
		LinePanel l2 = new LinePanel ();
		l2.add (new JLabel (Translator.swap ("AskAgainDialog.correctSyntax")));
		l2.addGlue ();
		...
		setTitle (Translator.swap ("AskAgainDialog"));
