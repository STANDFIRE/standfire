...
/**
 * IdRequest request for AMAPsim client/server connection.
 * 
...
public class IdRequest extends Request {
	...
	public int requestType;		// 7 = IdRequest
	
	
	public IdRequest (Object params) {
		dataLength = 9;
		messageId = "-id?-";
		requestType = 7;
	}
	...
	public String toString () {
		return "IdRequest: dataLength="+dataLength+" messageId="+messageId
