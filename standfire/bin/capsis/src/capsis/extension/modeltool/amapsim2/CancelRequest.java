...
/**
 * CancelRequest request for AMAPsim client/server connection.
 * 
...
public class CancelRequest extends Request {
	...
	public CancelRequest (Object params) {
		...
		if (params != null) {
			...
			CancelRequestDialog dlg = new CancelRequestDialog (this);
			dlg.dispose ();
	...
	public String toString () {
		StringBuffer b = new StringBuffer ("CancelRequest:");
		b.append (" dataLength=");
		b.append (dataLength);
		b.append (" messageId=");
		b.append (messageId);
