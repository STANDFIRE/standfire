...
public class AskStatusResponse extends Response {
	...
	public String toString () {
		return "AskStatusResponse: dataLength="+dataLength+" messageId="+messageId
