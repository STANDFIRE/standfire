...
/**
 * ForceAnswer request for AMAPsim client/server connection.
 * 
 * @author F. de Coligny - november 2002
 */
public class ForceAnswer extends Request {
	
	// Data to be sent to server
	public int dataLength;		// this field is not counted in dataLength	
	public String messageId;	// 5 chars
	public int requestType;		// 3 = ForceAnswer
	...
	public ForceAnswer (Object params) {
		...
		if (params != null) {
			...
			ForceAnswerDialog dlg = new ForceAnswerDialog (this);
			dlg.dispose ();
	...
	public String toString () {
		StringBuffer b = new StringBuffer ("ForceAnswer:");
		b.append (" dataLength=");
		b.append (dataLength);
		b.append (" messageId=");
		b.append (messageId);
