...
/**
 * AskStatus request for AMAPsim client/server connection.
 * 
 * @author F. de Coligny - november 2002
 */
public class AskStatus extends Request {
	
	// Data to be sent to server
	public int dataLength;		// this field is not counted in dataLength	
	public String messageId;	// 5 chars
	public int requestType;		// 6 = AskStatus
	
	
	public AskStatus (Object params) {
		dataLength = 9;
		//~ messageId = ProtocolManager.nextMessageId ();
		messageId = "-sta-";		// fc - 28.1.2004 - request 7
		requestType = 6;
	}
	...
	public String toString () {
		return "AskStatus: dataLength="+dataLength+" messageId="+messageId
