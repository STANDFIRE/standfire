...
/**
 * Hello request for AMAPsim client/server connection.
 * 
...
public class Hello extends Request {
	...
	public int requestType;		// 0 = Hello
	
	
	public Hello (Object params) {
		dataLength = 9;
		//~ messageId = ProtocolManager.nextMessageId ();
		messageId = "-hel-";		// fc - 28.1.2004 - request 7
		requestType = 0;
	}
	...
	public String toString () {
		return "Hello: dataLength="+dataLength+" messageId="+messageId
