...
/**
 * The OptimizerListener interface ensures the instance can listen different events that are fired 
 * by the OptimizerTool class.
 * @author Mathieu Fortin - July 2014
 */
public interface OptimizerListener extends ScenarioRecorderListener {
