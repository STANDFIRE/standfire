...
/**
 * This dialog box is used to set IncomeConstant parameters in interactive context.
 *
 * @author C. Orazio - february 2003
 */
public class IncomeConstantDialog extends AmapDialog implements ActionListener {
	...
	public IncomeConstantDialog () {
		super ();
		createUI ();
		setTitle (Translator.swap ("IncomeConstantDialog"));
	...
	private void okAction () {
		...
		if (!Check.isDouble (value.getText ().trim ())) {
			MessageDialog.print (this, Translator.swap ("IncomeConstantDialog.valueMustBeDouble"));
			return;
		}
	...
	private void createUI () {
		...
		l1.add (new JLabel (Translator.swap ("IncomeConstantDialog.value")+" :"));
