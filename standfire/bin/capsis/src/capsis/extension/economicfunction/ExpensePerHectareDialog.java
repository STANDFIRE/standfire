 ...
 */
public class ExpensePerHectareDialog extends AmapDialog implements ActionListener {
	...
	public ExpensePerHectareDialog () {
		super ();
		createUI ();
		setTitle (Translator.swap ("ExpensePerHectareDialog"));
	...
	public double getCost () {
		return Check.doubleValue (cost.getText ().trim ());
	}
	...
	private void okAction () {
		...
		// Checks...
		if (!Check.isDouble (cost.getText ().trim ())) {
			MessageDialog.print (this, Translator.swap ("ExpensePerHectareDialog.costMustBeDouble"));
			return;
		}
	...
	private void createUI () {
		...
		l1.add (new JLabel (Translator.swap ("ExpensePerHectareDialog.cost")+" :"));
