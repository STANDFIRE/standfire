 ...
 */
public class IncomePerVolumeDialog extends AmapDialog implements ActionListener {
	...
	public IncomePerVolumeDialog () {
		super ();
		createUI ();
		setTitle (Translator.swap ("IncomePerVolumeDialog"));
	...
	private void okAction () {
		...
		if (!Check.isDouble (value.getText ().trim ())) {
			MessageDialog.print (this, Translator.swap ("IncomePerVolumeDialog.valueMustBeDouble"));
			return;
		}
