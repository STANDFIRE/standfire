 ...
 */
public class DEHeightClassN extends DETimeG {
// fc - 30.4.2003 - added classWidth / minThreshold properties
	...
	static {
		Translator.addBundle("capsis.extension.dataextractor.DEHeightClassN");
	}
	 ...
	 */
	public DEHeightClassN () {}

	/**
	 * Official constructor. It uses the standard Extension starter.
	 */
	public DEHeightClassN (GenericExtensionStarter s) {
		super (s);
		labels = new Vector ();
	...
	public boolean matchWith (Object referent) {
		try {
			...
			//~ if (t instanceof Numberable) {return false;}	// fc - 30.4.2003 - adaptation for numberable trees
	...
	public boolean doExtraction () {
		...
		//System.out.println ("DEHeightClassN : extraction being made");
...
// bug correction : some maid trees may have number == 0 -> ignore them - tl 12/09/2005
	...
	public String getName() {
		return getNamePrefix ()+Translator.swap ("DEHeightClassN");
	}
	...
	public List<String> getAxesNames () {
		Vector v = new Vector ();
		v.add (Translator.swap ("DEHeightClassN.xLabel"));
		if (settings.perHa) {
			v.add (Translator.swap ("DEHeightClassN.yLabel")+" (ha)");
		} else {
			v.add (Translator.swap ("DEHeightClassN.yLabel"));
		}
		return v;
	}
	 ...
	 * From Extension interface.
	 */
	public String getDescription () {return Translator.swap ("DEHeightClassN.description");}
