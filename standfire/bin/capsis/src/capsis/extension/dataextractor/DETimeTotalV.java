...
public class DETimeTotalV extends DETimeG {
	...
	//~ /**
	 ...
	 //~ */
	//~ protected DETimeTotalV (Step stp) {
		super (s);
	}
	...
	public boolean matchWith (Object referent) {
		try {
			...
			if (!(mp instanceof TotalVProvider)) {return false;}
	...
	public boolean doExtraction () {
		...
		try {
			...
			for (Iterator i = steps.iterator (); i.hasNext ();) {
				...
				double V = ((TotalVProvider) methodProvider).
						getTotalV (stand, trees);
	...
	public String getName() {
		return getNamePrefix ()+Translator.swap ("DETimeTotalV");
	}
	 ...
	 * From Extension interface.
	 */
	public String getDescription () {return Translator.swap ("DETimeTotalV.description");}
