...
*   update C. Meredieu T; Labbé - April 2015
*/
public class DETimeVg2 extends PaleoDataExtractor implements DFCurves {
	...
	*/
	public DETimeVg2 (GenericExtensionStarter s) {
		...
		try {
			...
			Log.println (Log.ERROR, "DETimeVg2.c ()", "Exception occured while object construction : ", e);
		}
	}
	...
	*/
	public String getName () {
		return getNamePrefix ()+Translator.swap ("DETimeVg2");
	}
	...
	*/
	...
	/**	From Extension interface.
	*/
	public String getDescription () {return Translator.swap ("DETimeVg2.description");}
