 ...
 * @authorSDK
 */
public abstract class DEMultiX extends AbstractDataExtractor implements DFCurves {
	...
	public boolean doExtraction () {
		...
		try {
			...
			List<String> l1 = new ArrayList<String> ();		// x label

			
			// for each class
			int i = 0;
			for(Object cl : getTypes(stand)){
				c1.add (new Integer (i+1));
