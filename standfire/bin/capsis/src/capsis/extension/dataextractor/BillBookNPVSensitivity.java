...
/**	BillBook extension : sensitivity of NPV : Net Present Value NPV = "BAo"
*	@author F. de Coligny, O. Pain - may 2008
*/
public class BillBookNPVSensitivity extends PaleoDataExtractor implements DFColoredCurves {
	...
	static {
		Translator.addBundle("capsis.extension.dataextractor.BillBookNPVSensitivity");
	}

	/**	Phantom constructor.
	*	Only to ask for extension properties (authorName, version...).
	*/
	public BillBookNPVSensitivity () {}

	/**	Official constructor. It uses the standard Extension starter.
	*/
	public BillBookNPVSensitivity (GenericExtensionStarter s) {
		super (s);
		try {
			curves = new Vector ();
			labels = new Vector ();
			...
			Log.println (Log.ERROR, "BillBookNPVSensitivity.c ()", "Exception occured while object construction : ", e);
		}
	}
	...
	*/
	public boolean matchWith (Object referent) {
		try {
			...
			Log.println (Log.ERROR, "BillBookNPVSensitivity.matchWith ()", "Error in matchWith () (returned false)", e);
			return false;
		}
	}
...
//			double rate = 0.04;
			...
			for (String selectedName : selectedNames) {
				...
				for (double variation : variations) {
					...
					double x = variation;
					double NPV = FinancialTools.getNetPresentValue  (rate/100, result.getYears (), result.getCashFlows ());
			...
			Log.println (Log.ERROR, "BillBookNPVSensitivity.doExtraction ()", "Exception caught : ",exc);
			return false;
		}
	...
	*/
	public String getName () {
		String name = getNamePrefix ()+Translator.swap ("BillBookNPVSensitivity");
	...
	*/
	public List<String> getAxesNames () {
		Vector v = new Vector ();
		v.add (Translator.swap ("BillBookNPVSensitivity.xLabel"));
		//~ if (settings.perHa) {
			//~ v.add (Translator.swap ("BillBookNPVSensitivity.yLabel")+" (ha)");
		//~ } else {
			v.add (Translator.swap ("BillBookNPVSensitivity.yLabel"));
		//~ }
		return v;
	}
	...
	*/
	...
	/**	From Extension interface.
	*/
	public String getDescription () {return Translator.swap ("BillBookNPVSensitivity.description");}
