...
public class DETimeACGAMG extends DETimeG {
	...
	//~ /**
	 ...
	 //~ */
	//~ protected DETimeACGAMG (Step stp) {
		super (s);
		try {
			curves = new Vector ();
			labels = new Vector ();
			...
			Log.println (Log.ERROR, "DETimeACGAMG.c ()", "Exception occured while object construction : ", e);
		}
	}
	...
	public boolean doExtraction () {
		...
		try {
			...
			if (!i.hasNext ()) {throw new Exception ("DETimeACGAMG needs at least two steps");}	// fc - 9.4.2004
			Step s = (Step) i.next ();
	...
	public String getName() {
		return getNamePrefix ()+Translator.swap ("DETimeACGAMG");
	}
	 ...
	 * From Extension interface.
	 */
	public String getDescription () {return Translator.swap ("DETimeACGAMG.description");}
