...
/**	Basal area ("Grundfläche" (G), "surface terrière" en allemand)
*   over Time(/age) or over Hdom.
*   With possibilty to view annual increment
*	@author Ph. Dreyfus - january 2009
*/
public class DETimeG2 extends PaleoDataExtractor implements DFCurves {
	...
	static {
		Translator.addBundle("capsis.extension.dataextractor.DETimeG2");
	}
	...
	*/
	public DETimeG2 (GenericExtensionStarter s) {
		super (s);
		try {
			curves = new Vector ();
			...
			Log.println (Log.ERROR, "DETimeG2.c ()", "Exception occured while object construction : ", e);
		}
	}
	...
	*/
	public boolean matchWith (Object referent) {
		try {
			...
			Log.println (Log.ERROR, "DETimeG2.matchWith ()", "Error in matchWith () (returned false)", e);
			return false;
		}
	...
	*/
	public boolean doExtraction () {
		...
		try {
			...
			Log.println (Log.ERROR, "DETimeG2.doExtraction ()", "Exception caught : ",exc);
			return false;
		}
	...
	*/
	public String getName () {
		return getNamePrefix ()+Translator.swap ("DETimeG2");
	}
	...
	*/
	public List<String> getAxesNames () {
		Vector v = new Vector ();
		if (isSet ("xIsHdom")) { // PhD 2008-12-19
			v.add (Translator.swap ("DETimeG2.xLabelHdom"));
		} else {
			v.add (Translator.swap ("DETimeG2.xLabelDate"));
		}
		/*if (settings.perHa) {
			v.add (Translator.swap ("DETimeG2.yLabel")+" (/ha)");
		} else {
			v.add (Translator.swap ("DETimeG2.yLabel"));
		}*/
		String yLab;
		yLab = Translator.swap ("DETimeG2.yLabel");
		if (settings.perHa) {
			yLab = yLab +" (/ha)";
		}
		if (isSet ("incrementInsteadOfValue")) { // PhD 2008-06-25
	...
	*/
	...
	/**	From Extension interface.
	*/
	public String getDescription () {return Translator.swap ("DETimeG2.description");}
