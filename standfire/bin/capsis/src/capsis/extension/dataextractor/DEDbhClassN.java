...
// fc - 30.4.2003 - added classWidth / minThreshold properties
	...
	public void setConfigProperties () {
		...
		// TEMPORARILY DESACTIVATED TEMPORARILY DESACTIVATED TEMPORARILY DESACTIVATED
		// TEMPORARILY DESACTIVATED TEMPORARILY DESACTIVATED TEMPORARILY DESACTIVATED
		// TEMPORARILY DESACTIVATED TEMPORARILY DESACTIVATED TEMPORARILY DESACTIVATED
...
//~ System.out.println ("group: "+Tools.toString (gr));
			//~ Collection st = ((GTCStand) step.getStand ()).getTrees (getStatusProperty ());
//~ System.out.println ("status: "+Tools.toString (st));
			//~ Collection intersection = new ArrayList (gr);
			//~ intersection.retainAll (st);
//~ System.out.println ("intersection: "+Tools.toString (intersection));
...
//~ System.out.println ("DEDbhClassN : minCat="+minCat+" maxCat="+maxCat);
	...
	public String getName() {
		return getNamePrefix ()+Translator.swap ("DEDbhClassN");
	}
	 ...
	 * From Extension interface.
	 */
	public String getDescription () {return Translator.swap ("DEDbhClassN.description");}
