 ...
 */
public class DETimeHdomHg extends DETimeG {
	protected Vector curves;
	protected Vector labels;
	protected MethodProvider methodProvider;

	static {
		Translator.addBundle("capsis.extension.dataextractor.DETimeHdomHg");
	}
	 ...
	 */
	public DETimeHdomHg (GenericExtensionStarter s) {
		//~ this (s.getStep ());
	//~ }
	...
	//~ /**
	 ...
	 //~ */
	//~ protected DETimeHdomHg (Step stp) {
		super (s);
		try {
			curves = new Vector ();
			labels = new Vector ();
			...
			Log.println (Log.ERROR, "DETimeHdomHg.c ()", "Exception occured while object construction : ", e);
		}
	}
	...
	public boolean matchWith (Object referent) {
		try {
			...
			Log.println (Log.ERROR, "DETimeHdomHg.matchWith ()", "Error in matchWith () (returned false)", e);
			return false;
		}
		return true;
	}
	...
	public boolean doExtraction () {
		...
		try {
			...
			Log.println (Log.ERROR, "DETimeHdomHg.doExtraction ()", "Exception caught : ",exc);
			return false;
		}
	...
	public String getName() {
		return getNamePrefix ()+Translator.swap ("DETimeHdomHg");
	}
	...
	public List<String> getAxesNames () {
		Vector v = new Vector ();
		v.add (Translator.swap ("DETimeHdomHg.xLabel"));
			v.add (Translator.swap ("DETimeHdomHg.yLabel"));
		return v;
	}
	 ...
	 * From Extension interface.
	 */
	public String getDescription () {return Translator.swap ("DETimeHdomHg.description");}
