...
public class DETimeRatioV6V4 extends DETimeG {
	...
	//~ /**
	 ...
	 //~ */
	//~ protected DETimeRatioV6V4 (Step stp) {
		super (s);
		try {
			curves = new Vector ();
			labels = new Vector ();
			...
			Log.println (Log.ERROR, "DETimeRatioV6V4.c ()", "Exception occured while object construction : ", e);
		}
	}
	...
	public boolean matchWith (Object referent) {
		try {
			...
			if (!(mp instanceof TopEndD4VProvider)) {return false;}
	...
	public String getName() {
		return getNamePrefix ()+Translator.swap ("DETimeRatioV6V4");
	}
	 ...
	 * From Extension interface.
	 */
	public String getDescription () {return Translator.swap ("DETimeRatioV6V4.description");}
