...
public class DEDbhLeafSurface extends DETimeG {
	...
	//~ /**
	 ...
	 //~ */
	//~ protected DEDbhLeafSurface (Step stp) {
		super (s);
	}
	...
	public String getName() {
		return getNamePrefix ()+Translator.swap ("DEDbhLeafSurface");
	}
	 ...
	 * From Extension interface.
	 */
	public String getDescription () {return Translator.swap ("DEDbhLeafSurface.description");}
