...
public class DETimeHCrownBaseH extends DETimeG {
	...
	//~ /**
	 ...
	 //~ */
	//~ protected DETimeHCrownBaseH (Step stp) {
		super (s);
		try {
			curves = new Vector ();
			labels = new Vector ();
			...
			Log.println (Log.ERROR, "DETimeHCrownBaseH.c ()", "Exception occured while object construction : ", e);
		}
	}
	...
	public String getName() {
		return Translator.swap ("DETimeHCrownBaseH");
	}
	 ...
	 * From Extension interface.
	 */
	public String getDescription () {return Translator.swap ("DETimeHCrownBaseH.description");}
