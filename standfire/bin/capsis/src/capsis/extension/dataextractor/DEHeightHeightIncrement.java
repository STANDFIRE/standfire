...
public class DEHeightHeightIncrement extends DETimeG {
	...
	//~ /**
	 ...
	 //~ */
	//~ protected DEHeightHeightIncrement (Step stp) {
		super (s);
		labels = new Vector ();
	}
	...
	public boolean doExtraction () {
		...
		//System.out.println ("DEHeightHeightIncrement : extraction being made");
	...
	public String getName() {
		return getNamePrefix ()+Translator.swap ("DEHeightHeightIncrement");
	}
	 ...
	 * From Extension interface.
	 */
	public String getDescription () {return Translator.swap ("DEHeightHeightIncrement.description");}
