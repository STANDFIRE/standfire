...
/**
 * Numbers of trees per girth class.
 *
 * @author Ph. Dreyfus - june 2001
 */
public class DEGirthDistrib extends DETimeG {
	private Vector labels;
	protected MethodProvider methodProvider;

	static {
		Translator.addBundle("capsis.extension.dataextractor.DEGirthDistrib");
	}
	 ...
	 */
	public DEGirthDistrib () {}

	/**
	 * Official constructor. It uses the standard Extension starter.
	 */
	public DEGirthDistrib (GenericExtensionStarter s) {
		super (s);
		labels = new Vector ();
	}
	...
	public boolean doExtraction () {
		...
		//System.out.println ("DEGirthDistrib : extraction being made");
		...
		try {
			...
			// security
			// DEGirthDistribSettings mySettings = (DEGirthDistribSettings) getSettings ();
...
// bug correction : some maid trees may have number == 0 -> ignore them - tl 12/09/2005
			...
			Log.println (Log.ERROR, "DEGirthDistrib.doExtraction ()", "Exception caught : ",exc);
			return false;
		}
	...
	public String getName() {
		return getNamePrefix ()+Translator.swap ("DEGirthDistrib");
	}
	...
	public List<String> getAxesNames () {
		Vector v = new Vector ();
		v.add (Translator.swap ("DEGirthDistrib.xLabel"));
		if (settings.perHa) {
			v.add (Translator.swap ("DEGirthDistrib.yLabel")+" (ha)");
		} else {
			v.add (Translator.swap ("DEGirthDistrib.yLabel"));
		}
		return v;
	}
	 ...
	 * From Extension interface.
	 */
	public String getDescription () {return Translator.swap ("DEGirthDistrib.description");}
