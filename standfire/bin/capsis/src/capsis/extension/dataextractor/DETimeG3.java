...
public class DETimeG3 extends PaleoDataExtractor implements DFCurves {
	...
	*/
	public DETimeG3 (GenericExtensionStarter s) {
		...
		try {
			...
			setPropertyEnabled ("xIsCdom", availableDdom); // cm tl 14 04 2015 Ddom provider is available
		} catch (Exception e) {
			Log.println (Log.ERROR, "DETimeG3.c ()", "Exception occured while object construction : ", e);
		}
	}
	...
	*/
	public String getName () {
		return getNamePrefix ()+Translator.swap ("DETimeG3");
	}
	...
	*/
	public List<String> getAxesNames () {
		...
		/*if (settings.perHa) {
			v.add (Translator.swap ("DETimeG3.yLabel")+" (/ha)");
		} else {
			v.add (Translator.swap ("DETimeG3.yLabel"));
		}*/
		String yLab;
	...
	*/
	...
	/**	From Extension interface.
	*/
	public String getAuthor () {return "C. Meredieu and T. Labbe";}

	/**	From Extension interface.
	*/
	public String getDescription () {return Translator.swap ("DETimeG3.description");}
