...
public class DEDbhHeight extends DETimeG {
	...
	//~ /**
	 ...
	 //~ */
	//~ protected DEDbhHeight (Step stp) {
		super (s);
		labels = new Vector ();
	}
...
// bug correction : some maid trees may have number == 0 -> ignore them - tl 12/09/2005
	...
	public String getName() {
		return getNamePrefix ()+Translator.swap ("DEDbhHeight");
	}
	 ...
	 * From Extension interface.
	 */
	public String getDescription () {return Translator.swap ("DEDbhHeight.description");}
