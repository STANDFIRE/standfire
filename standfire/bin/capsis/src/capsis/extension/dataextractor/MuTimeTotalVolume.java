...
import capsis.util.methodprovider.MuTotalVolume;

/**	Evolution of Total Volume over Time in a MultipartScene.
 *	@author F. de Coligny - february 2011
 */
public class MuTimeTotalVolume extends MuTimeGraph {

	static {
		Translator.addBundle("capsis.extension.dataextractor.MuTimeTotalVolume");
	}
	...
	/**	Default constructor.
	 */
	public MuTimeTotalVolume () {}

	/**	Constructor.
	 */
	public MuTimeTotalVolume (GenericExtensionStarter s) {super (s);}
	...
	public boolean matchWithPart (GModel model, MultipartScene scene, ScenePart part) {
		...
		return mp != null && mp instanceof MuTotalVolume;
	}
	...
	public double getValue (GModel model, MultipartScene scene, ScenePart part) {
		...
		MuTotalVolume m = (MuTotalVolume) mp;
		return m.getTotalVolume (scene, part);
	}
	
	/**	Graph name.
	 */
	public String getGraphName () {
		return Translator.swap ("MuTimeTotalVolume");
	}
	
	public String getYAxisName () {return Translator.swap ("MuTimeTotalVolume.yLabel");}
	 ...
	 */
	public String getDescription () {return Translator.swap ("MuTimeTotalVolume.description");}
