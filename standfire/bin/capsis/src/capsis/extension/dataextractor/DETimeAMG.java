...
/**
 * Mean Basal area increment ("Grundflache" (G), "surface terrière") versus Date.
 *
 * @author L. Saint-André - august 2002
 */
public class DETimeAMG extends PaleoDataExtractor implements DFCurves {	// MultiConfigurable goes up to DataExtractor
	...
	//~ /**
	 ...
	 //~ */
	//~ protected DETimeAMG (Step stp) {
		super (s);
		try {
			curves = new Vector ();
			// MOVED TO SUPERCLASS retrieveSettings ();
		} catch (Exception e) {
			Log.println (Log.ERROR, "DETimeAMG.c ()", "Exception occured while object construction : ", e);
		}
	}
	...
	public boolean matchWith (Object referent) {
		try {
			...
			if (!(mp instanceof AMGProvider)) {return false;}
	...
	public String getName () {
		return getNamePrefix ()+Translator.swap ("DETimeAMG");
	}
	 ...
	 * From Extension interface.
	 */
	public String getDescription () {return Translator.swap ("DETimeAMG.description");}
