...
import capsis.util.methodprovider.MuHdom;

/**	Evolution of Hdom (dominant height) over Time in a MultipartScene.
*	@author F. de Coligny - january 2011
*/
public class MuTimeHdom extends MuTimeGraph {

	static {
		Translator.addBundle("capsis.extension.dataextractor.MuTimeHdom");
	}
	...
	/**	Constructor.
	 */
	public MuTimeHdom (GenericExtensionStarter s) {super (s);}
	...
	public boolean matchWithPart (GModel model, MultipartScene scene, ScenePart part) {
		...
		return mp != null && mp instanceof MuHdom;
	}
	...
	public double getValue (GModel model, MultipartScene scene, ScenePart part) {
		...
		MuHdom m = (MuHdom) mp;
		return m.getHdom (scene, part);
	}
	
	/**	Graph name.
	 */
	public String getGraphName () {
		return Translator.swap ("MuTimeHdom");
	}
	
	public String getYAxisName () {return Translator.swap ("MuTimeHdom.yLabel");}
	 ...
	 */
	public String getDescription () {return Translator.swap ("MuTimeHdom.description");}
