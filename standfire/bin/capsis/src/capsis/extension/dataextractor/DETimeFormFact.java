...
public class DETimeFormFact extends DETimeG {
	...
	//~ /**
	 ...
	 //~ */
	//~ protected DETimeFormFact (Step stp) {
		super (s);
	}
	...
	public String getName() {
		return getNamePrefix ()+Translator.swap ("DETimeFormFact");
	}
	 ...
	 * From Extension interface.
	 */
	public String getDescription () {return Translator.swap ("DETimeFormFact.description");}
