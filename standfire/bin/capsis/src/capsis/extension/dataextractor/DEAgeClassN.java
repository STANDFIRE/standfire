...
// fc - 30.4.2003 - added classWidth / minThreshold properties
	...
	public void setConfigProperties () {
		...
		addIntProperty ("classWidthInYears", 5);
		addIntProperty ("minThresholdInYears", 0);
...
//			System.out.println ("DEAgeClassN 1...");
			...
			int minThreshold = getIntProperty ("minThresholdInYears");
			int classWidth = getIntProperty ("classWidthInYears");
...
// bug correction : some maid trees may have number == 0 -> ignore them - fc - 22.8.2006 - (tl 12/09/2005)
...
//				System.out.println ("DEAgeClassN 5...");
				...
				if (age < minThreshold) {continue;}		// fc - 20.4.2003
...
//			System.out.println ("DEAgeClassN 6...");
			...
			for (int i = minCat; i <= maxCat; i++) {
				...
				cpt++;
				if (cpt > 1000) throw new Exception ("Detected a neverending loop in DEAgeClassN");
...
//		System.out.println ("DEAgeClassN 9...");
	...
	public String getName() {
		return getNamePrefix ()+Translator.swap ("DEAgeClassN");
	}
	 ...
	 * From Extension interface.
	 */
	public String getDescription () {return Translator.swap ("DEAgeClassN.description");}
