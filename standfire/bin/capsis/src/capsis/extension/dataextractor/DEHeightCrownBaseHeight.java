...
/**
 * Tree height crown base height scatterplot.
 *
 * @author B. Courbaud - November 2001
 */
public class DEHeightCrownBaseHeight extends DETimeG {
	private Vector labels;

	static {
		Translator.addBundle("capsis.extension.dataextractor.DEHeightCrownBaseHeight");
	}

	/**
	 * Default constructor.
	 */
	public DEHeightCrownBaseHeight () {}

	/**
	 * Constructor.
	 */
	public DEHeightCrownBaseHeight (GenericExtensionStarter s) {
		super (s);
	...
	public boolean matchWith (Object referent) {
		try {
			...
			if (!(mp instanceof TreeCrownBaseHeightProvider)) {return false;}
			...
			Log.println (Log.ERROR, "DEHeightCrownBaseHeight.matchWith ()", "Error in matchWith () (returned false)", e);
			return false;
		}
	...
	public boolean doExtraction () {
		...
		//System.out.println ("DEHeightCrownBaseHeight : extraction being made");
		try {
...
// bug correction : some maid trees may have number == 0 -> ignore them - tl 12/09/2005
			...
			y1Labels.add ("H");
			labels.add (y1Labels);			// y1 : label "H"
			Vector y2Labels = new Vector ();
			y2Labels.add ("CBH");
			labels.add (y2Labels);			// y2 : label "CBH"

		} catch (Exception exc) {
			Log.println (Log.ERROR, "DEHeightCrownBaseHeight.doExtraction ()", "Exception caught : ",exc);
			return false;
		}
	...
	public String getName() {
		return getNamePrefix ()+Translator.swap ("DEHeightCrownBaseHeight");
	}
...
*/
	...
	public List<String> getAxesNames () {
		Vector v = new Vector ();
		v.add (Translator.swap ("DEHeightCrownBaseHeight.xLabel"));
		v.add (Translator.swap ("DEHeightCrownBaseHeight.yLabel"));
		return v;
	}
	 ...
	 * From Extension interface.
	 */
	public String getDescription () {return Translator.swap ("DEHeightCrownBaseHeight.description");}
