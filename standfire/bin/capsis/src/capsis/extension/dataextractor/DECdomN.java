...
/**
 * Number of trees  versus Date.
 * (From DETimeN.java)
 * @author T. Labb̩, C. Meredieu - september 2003
 */
...
// tl 29.1.2007 from DEGirthClassN
	...
	public boolean doExtraction () {
		...
		try {
			...
			for (Iterator i = steps.iterator (); i.hasNext ();) {
				...
				double Cdom = Math.PI * ((DdomProvider) methodProvider).getDdom (stand, trees);	// (Ddom : cm)
	...
	public String getName() {
		return getNamePrefix ()+Translator.swap ("DECdomN");
	}
	 ...
	 * From Extension interface.
	 */
	public String getDescription () {return Translator.swap ("DECdomN.description");}
