...
/**
 * VanWagner : a crown damage model
 * 
 * @author F. Pimont - september 2009
 */
public class VanWagner implements CrownDamageModel {
	...
	*/
	public double getDamageHeight(double thresholdTemperature, // threshold
		...
		double crownScorchHeight = 4.55 * Tools.plume(fireIntensity,
				ambiantTemperature, thresholdTemperature);
		System.out.println("debbugging van wagner: I="+fireIntensity+";T="+ambiantTemperature+";deltaTemperature="+thresholdTemperature+";CSH1="+crownScorchHeight);
		return Tools.includeWindEffect(crownScorchHeight, fireIntensity,
				ambiantTemperature, windVelocity);
	}
	
	public String getName() {
		return Translator.swap("Van Wagner 1977 (Default)");
	}
