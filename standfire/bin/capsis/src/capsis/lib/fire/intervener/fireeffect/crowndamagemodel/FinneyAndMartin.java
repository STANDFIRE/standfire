...
/**
 * FinneyAndMartin : a crown damage model
 * 
 * @author F. Pimont - september 2009
 */
public class FinneyAndMartin implements CrownDamageModel {

	/**	Constructor.
	*/
	public FinneyAndMartin () {}
	...
	*/
	public double getDamageHeight(double thresholdTemperature, // threshold
		...
		double crownScorchHeight = 8.9 * Tools.plume(fireIntensity,
	...
	public String getName () {return Translator.swap ("Finney & Martin 1992");}
