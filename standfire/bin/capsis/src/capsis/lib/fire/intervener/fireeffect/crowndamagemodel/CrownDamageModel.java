...
/**	CrownDamageModel : an interface for crown damage models
*	@author F. Pimont - september 2009
*/
public interface CrownDamageModel {

	/**	Returns the damage height in the crown (m). 
	*	The height is relative to the ground level.
	*/
	public double getDamageHeight (double thresholdTemperature,	// threshold temperature for the damage �C
			double fireIntensity, 		// kW/m
			double residenceTime,		// s
			double ambiantTemperature, 	// �C
			double windVelocity,		// m/s
			String damageType); //FiModel.CROWN_SCORCHED or FiModel.BUD_KILLED
}
