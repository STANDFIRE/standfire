...
//		Collection data = new ArrayList ();	// Strings
		...
		if(es.isDateAfterIntervention()){
			append (sb,Translator.swap ("EconomicTextViewer.dateAfterIntervention"));
		}else{
			append (sb,Translator.swap ("EconomicTextViewer.dateBeforeIntervention"));
		}
		
		append (sb,Translator.swap ("EconomicTextViewer.nyears") + " : " + es.getnYears());
		if(es.isLandIsEstimated()==true){append (sb,Translator.swap ("discountRate") + " : " + es.getDiscountRate());}
		if(es.isLandIsEstimated()==false){append (sb,Translator.swap ("land") + " : " + es.getLand());}
...
//		}
		...
		append (sb,"--------------------------------------");
		append (sb,Translator.swap ("EconomicTextViewer.titleIndicators"));
		append (sb,"--------------------------------------");
