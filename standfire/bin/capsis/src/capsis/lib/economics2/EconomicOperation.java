...
public class EconomicOperation {
	...
	@Ignore
	protected Trigger trigger=Trigger.ON_INTERVENTION;
	@Ignore
...
//	}
	...
	public double getValue(EconomicScene s, EconomicScenario scenario) { // Euros
		...
		if(economicTrees == null){economicTrees = (List<EconomicTree>) s.getLivingEconomicTrees();}
...
//			List<EconomicTree> trees = s.getEconomicTrees (); //TODO : not compatible with diameter class model
...
//					
//					try{
//						pricebydbh = settings.getPriceByDbh (t.getDbh(), t.getSpeciesValue());
//					}catch(Exception e){
//						Log.println (Log.ERROR,"EconomicOperation.getValue()",e.toString ());
//					}
//					
//					v += t.getEconomicVolume_m3 () * pricebydbh;
//				}
//			}
...
//					pricebydbh = settings.getPriceByDbh (t.getDbh(), t.getSpeciesValue());
//				}catch(Exception e){
//					Log.println (Log.ERROR,"calcValueOfTrees.getValue()",e.toString ());
//				}
//				v += t.getEconomicVolume_m3 () * pricebydbh;
