...
/**
 * DVirtualStandXY - Dialog box to set the parameters concerning the locations of trees 
 * for a virtual stand.
 * Parameters can be stored in the module settings object.
 *
 * @author F Goreaud - june 2001 -> 18/8/02
 */
public class DVirtualStandXY extends AmapDialog implements ActionListener {
//checked for c4.1.1_09 - fc - 5.2.2003
	 ...
	 * Constructor.
	 */
	public DVirtualStandXY (VirtualParameters vp) {
		super ();
	...
	private void okAction () {
		...
		vParam.virtualStandXmin = new Double (p10.getText ()).doubleValue ();
		...
		vParam.virtualStandXmax = new Double (p11.getText ()).doubleValue ();
		...
		vParam.virtualStandYmin = new Double (p12.getText ()).doubleValue ();
		...
		vParam.virtualStandYmax = new Double (p13.getText ()).doubleValue ();
	...
	*/
	private void createUI () {
		...
		Border bor = BorderFactory.createTitledBorder (etched,  Translator.swap ("DVirtualStandXY.treePattern"));
		XYPanel.setBorder (bor);
		Box box = Box.createVerticalBox ();
		CheckboxGroup cbg = new CheckboxGroup();
		
		/*JPanel li1 = new JPanel (new FlowLayout (FlowLayout.LEFT));
		cb1 = new Checkbox( Translator.swap ("DVirtualStandXY.xyfile"),false,cbg);
		li1.add (cb1);
		fldXYInventory = new JTextField (15);
		browseButton = new JButton (Translator.swap ("MountDInitStand.browse"));
		//browseButton.addActionListener (this);
		li1.add (fldXYInventory);
		...
		//cb2 = new Checkbox(Translator.swap ("DVirtualStandXY.randomPattern"),(vParam.virtualStandXY==1),cbg);
		li5.add (rdRandom);
		box.add (li5);
		...
		//cb3 = new Checkbox(Translator.swap ("DVirtualStandXY.neymanScottPattern"),(vParam.virtualStandXY==2),cbg);
		...
		//cb4 = new Checkbox(Translator.swap ("DVirtualStandXY.gibbsPattern"),(vParam.virtualStandXY==3),cbg);
		li7.add (rdGibbs);
		...
		setTitle (Translator.swap ("DVirtualStandXY"));
