...
public class QuestMobWriter {
	 ...
	 * Constructor.
	 */
	public QuestMobWriter(Tree tree, List<QuestGU> gus) {
	...
	public void save(String fileName) throws Exception {
		try {
			...
			Log.println(Log.ERROR, "QuestMobWriter.save ()", "Could not write in file: " + fileName, e);
			throw e;
		}
	}
