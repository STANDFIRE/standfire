...
package capsis.lib.math;	// fc + ecd - 21.11.2006
...
/*	Usage:
	...
	double u=r.nextUniform(); // Generate U(0,1)
	double g=r.nextGaussian(); // Generate N(0,1)
	int i=r.nextInt(5); // Generate Discrete Uniform({0,1,2,3,4})
	double g=r.nextBeta(2,4); // Generate Beta(2,4)
*/
