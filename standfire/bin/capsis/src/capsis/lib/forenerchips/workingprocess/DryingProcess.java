...
/**
 * A drying working process (séchage)
 * 
 * @author N. Bilot - April 2013
 */
public class DryingProcess extends WorkingProcess {
  ...
  private String name;
	 ...
	 * Constructor
	 */
	public DryingProcess (String name, double duration_month, boolean cover) throws Exception {
		super ("DryingProcess");
	 ...
	 */
	static public DryingProcess getInstance (String name, String parameters) throws Exception {
    ...
    String wpName = name;
		...
		return new DryingProcess (name, duration_month, cover);
	}
	...
	/**
	 * Calculates the loss in dry biomass (t) due to the drying process.
	 * (reference ?)
	 */
