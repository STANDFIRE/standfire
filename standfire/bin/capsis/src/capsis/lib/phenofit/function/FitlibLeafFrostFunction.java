...
//			if (pheno.isDeciduous() && pheno.getLeafSenescenceDate() != 0 && day > pheno.getLeafSenescenceDate()) {
...
//			System.out.println("dayClim.tmn: "+dayClim.tmn); // rounded ???
			...
			if (frostDamage < 1) {
				...
				// pheno.leafFrostStates.setValue(day, 1 - FD);
			} else {
				pheno.setLeafIndex(FitlibConstants.ALMOST_ZERO);
				// pheno.leafFrostStates.setValue(day,
				// FitlibConstants.ALMOST_ZERO);
			}
